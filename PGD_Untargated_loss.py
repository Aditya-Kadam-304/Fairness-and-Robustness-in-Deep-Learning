...
logging.basicConfig(filename='PGD_Untargated_SQ_Loss1_Resnet18.log', level=logging.INFO)
...
def Train(net, trainloader, optimizer, scheduler, epochs, org_loss, loss_class):
    net.train()
    loss_data = []
    accuracy = []
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
...
if __name__ == "__main__":
    ...
    num_epochs = 60
    Balanced= True #True only for robust loss calculations i.e. loss_class = True
    ...
    #Training
    train_loss, train_acc  = Train(net=model, trainloader=train_loader, optimizer=optimizer,scheduler= scheduler,epochs= num_epochs, org_loss = False, loss_class=True)
    #torch.save(model.state_dict(), 'PGD_Untargated_attack_Loss_Resnet18.pth')
    #plot_loss_vs_epoch(train_loss, train_acc ,filename= "PGD_Untargated_attack_Loss_Training_Loss_&_Accuracy_vs_Epoch.png", title="PGD_Untargated_attack_Loss_Training_Loss_&_Accuracy_vs_Epoch")
    ...
    #Targated_model = load_model('PGD_Untargated_attack_Loss_Resnet18.pth', device)
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes, title= "PGD_Untargated_attack_Loss_Confusion_matrix_Standard_Data", filename="PGD_Untargated_attack_Loss_Confusion_matrix_Standard_Data.png")
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes,title= "PGD_Untargated_attack_Loss_Confusion_matrix_Untargated_Data", filename="PGD_Untargated_attack_Loss_Confusion_matrix_Untargated_Data.png")
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes,title= "PGD_Untargated_attack_Loss_Confusion_matrix_Targated_Data",  filename="PGD_Untargated_attack_Loss_Confusion_matrix_Targated_Data.png")
