...
logging.basicConfig(filename='PGD_Targatted_L2_loss1_Resnet18.log', level=logging.INFO)
...
if __name__ == "__main__":
    ...
    #torch.save(model.state_dict(), 'PGD_Targatted_attack_loss_Resnet18.pth')

    #plot_loss_vs_epoch(train_loss, train_acc ,title="PGD_Targated_attack_loss_Training_Loss_&_Accuracy_vs_Epoch", filename= "PGD_Targated_attack_loss_Training_Loss_&_Accuracy_vs_Epoch.png", )
    ...
    #Targated_model = load_model('PGD_Targatted_attack_loss_Resnet18.pth', device)
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes, title= "PGD_Targated_attack_loss_Confusion_matrix_Standard_Data", filename="PGD_Targated_attack_loss_Confusion_matrix_Standard_Data.png")
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes,title= "PGD_Targated_attack_loss_Confusion_matrix_Untargated_Data", filename="PGD_Targated_attack_loss_Confusion_matrix_Untargated_Data.png")
    ...
    #plot_confusion_matrix(all_targets, all_preds, classes,title= "PGD_Targated_attack_loss_Confusion_matrix_Targated_Data",  filename="PGD_Targated_attack_loss_Confusion_matrix_Targated_Data.png")
